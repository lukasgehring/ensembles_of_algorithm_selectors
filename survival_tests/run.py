...
def create_approach(approach_names):
    ...
    for approach_name in approach_names:
        ...
        if approach_name == 'bagging-per_algorithm_regressor_logrank':
            approaches.append(Bagging(num_base_learner=10, base_learner=PerAlgorithmRegressor(), use_ranking=True, log_ranking=True))
