...
def generate_sbs_vbs_change_table():
    ...
    ax.bar(ind + 3 * width / 2, stacking_regression_new.result, width, color=color3,
           label='Stacking SelectKBest f_regression')
    ax.bar(ind + 5 * width / 2, stacking_mutual.result, width, color=color4, label='Stacking SelectKBest mutual_info_regression')
