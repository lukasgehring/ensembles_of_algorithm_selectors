...
def generate_sbs_vbs_change_table():
    ...
    asp = get_dataframe_for_sql_query(
        "SELECT scenario_name, approach, fold, n_par10 as result FROM (SELECT vbs_sbs.scenario_name, vbs_sbs.fold, adaboostsamme_per_algo_40_it.approach, vbs_sbs.metric, adaboostsamme_per_algo_40_it.result, ((adaboostsamme_per_algo_40_it.result - vbs_sbs.oracle_result)/(vbs_sbs.sbs_result -vbs_sbs.oracle_result)) as n_par10,vbs_sbs.oracle_result, vbs_sbs.sbs_result FROM (SELECT oracle_table.scenario_name, oracle_table.fold, oracle_table.metric, oracle_result, sbs_result FROM (SELECT scenario_name, fold, approach, metric, result as oracle_result FROM `vbs_sbs` WHERE approach='oracle') as oracle_table JOIN (SELECT scenario_name, fold, approach, metric, result as sbs_result FROM `vbs_sbs` WHERE approach='sbs') as sbs_table ON oracle_table.scenario_name = sbs_table.scenario_name AND oracle_table.fold=sbs_table.fold AND oracle_table.metric = sbs_table.metric) as vbs_sbs JOIN adaboostsamme_per_algo_40_it ON vbs_sbs.scenario_name = adaboostsamme_per_algo_40_it.scenario_name AND vbs_sbs.fold = adaboostsamme_per_algo_40_it.fold AND vbs_sbs.metric = adaboostsamme_per_algo_40_it.metric WHERE vbs_sbs.metric='par10') as final WHERE metric='par10' AND NOT scenario_name='CSP-Minizinc-Obj-2016' AND approach LIKE '%SAMME_per_algorithm_regressor%' AND scenario_name='ASP-POTASSCO'")
    bnsl = get_dataframe_for_sql_query(
        "SELECT scenario_name, approach, fold, n_par10 as result FROM (SELECT vbs_sbs.scenario_name, vbs_sbs.fold, adaboostsamme_per_algo_40_it.approach, vbs_sbs.metric, adaboostsamme_per_algo_40_it.result, ((adaboostsamme_per_algo_40_it.result - vbs_sbs.oracle_result)/(vbs_sbs.sbs_result -vbs_sbs.oracle_result)) as n_par10,vbs_sbs.oracle_result, vbs_sbs.sbs_result FROM (SELECT oracle_table.scenario_name, oracle_table.fold, oracle_table.metric, oracle_result, sbs_result FROM (SELECT scenario_name, fold, approach, metric, result as oracle_result FROM `vbs_sbs` WHERE approach='oracle') as oracle_table JOIN (SELECT scenario_name, fold, approach, metric, result as sbs_result FROM `vbs_sbs` WHERE approach='sbs') as sbs_table ON oracle_table.scenario_name = sbs_table.scenario_name AND oracle_table.fold=sbs_table.fold AND oracle_table.metric = sbs_table.metric) as vbs_sbs JOIN adaboostsamme_per_algo_40_it ON vbs_sbs.scenario_name = adaboostsamme_per_algo_40_it.scenario_name AND vbs_sbs.fold = adaboostsamme_per_algo_40_it.fold AND vbs_sbs.metric = adaboostsamme_per_algo_40_it.metric WHERE vbs_sbs.metric='par10') as final WHERE metric='par10' AND NOT scenario_name='CSP-Minizinc-Obj-2016' AND approach LIKE '%SAMME_per_algorithm_regressor%' AND scenario_name='BNSL-2016'")
    cpmp = get_dataframe_for_sql_query(
        "SELECT scenario_name, approach, fold, n_par10 as result FROM (SELECT vbs_sbs.scenario_name, vbs_sbs.fold, adaboostsamme_per_algo_40_it.approach, vbs_sbs.metric, adaboostsamme_per_algo_40_it.result, ((adaboostsamme_per_algo_40_it.result - vbs_sbs.oracle_result)/(vbs_sbs.sbs_result -vbs_sbs.oracle_result)) as n_par10,vbs_sbs.oracle_result, vbs_sbs.sbs_result FROM (SELECT oracle_table.scenario_name, oracle_table.fold, oracle_table.metric, oracle_result, sbs_result FROM (SELECT scenario_name, fold, approach, metric, result as oracle_result FROM `vbs_sbs` WHERE approach='oracle') as oracle_table JOIN (SELECT scenario_name, fold, approach, metric, result as sbs_result FROM `vbs_sbs` WHERE approach='sbs') as sbs_table ON oracle_table.scenario_name = sbs_table.scenario_name AND oracle_table.fold=sbs_table.fold AND oracle_table.metric = sbs_table.metric) as vbs_sbs JOIN adaboostsamme_per_algo_40_it ON vbs_sbs.scenario_name = adaboostsamme_per_algo_40_it.scenario_name AND vbs_sbs.fold = adaboostsamme_per_algo_40_it.fold AND vbs_sbs.metric = adaboostsamme_per_algo_40_it.metric WHERE vbs_sbs.metric='par10') as final WHERE metric='par10' AND NOT scenario_name='CSP-Minizinc-Obj-2016' AND approach LIKE '%SAMME_per_algorithm_regressor%' AND scenario_name='CPMP-2015'")
    csp = get_dataframe_for_sql_query(
        "SELECT scenario_name, approach, fold, n_par10 as result FROM (SELECT vbs_sbs.scenario_name, vbs_sbs.fold, adaboostsamme_per_algo_40_it.approach, vbs_sbs.metric, adaboostsamme_per_algo_40_it.result, ((adaboostsamme_per_algo_40_it.result - vbs_sbs.oracle_result)/(vbs_sbs.sbs_result -vbs_sbs.oracle_result)) as n_par10,vbs_sbs.oracle_result, vbs_sbs.sbs_result FROM (SELECT oracle_table.scenario_name, oracle_table.fold, oracle_table.metric, oracle_result, sbs_result FROM (SELECT scenario_name, fold, approach, metric, result as oracle_result FROM `vbs_sbs` WHERE approach='oracle') as oracle_table JOIN (SELECT scenario_name, fold, approach, metric, result as sbs_result FROM `vbs_sbs` WHERE approach='sbs') as sbs_table ON oracle_table.scenario_name = sbs_table.scenario_name AND oracle_table.fold=sbs_table.fold AND oracle_table.metric = sbs_table.metric) as vbs_sbs JOIN adaboostsamme_per_algo_40_it ON vbs_sbs.scenario_name = adaboostsamme_per_algo_40_it.scenario_name AND vbs_sbs.fold = adaboostsamme_per_algo_40_it.fold AND vbs_sbs.metric = adaboostsamme_per_algo_40_it.metric WHERE vbs_sbs.metric='par10') as final WHERE metric='par10' AND NOT scenario_name='CSP-Minizinc-Obj-2016' AND approach LIKE '%SAMME_per_algorithm_regressor%' AND scenario_name='CSP-2010'")
    csp_time = get_dataframe_for_sql_query(
        "SELECT scenario_name, approach, fold, n_par10 as result FROM (SELECT vbs_sbs.scenario_name, vbs_sbs.fold, adaboostsamme_per_algo_40_it.approach, vbs_sbs.metric, adaboostsamme_per_algo_40_it.result, ((adaboostsamme_per_algo_40_it.result - vbs_sbs.oracle_result)/(vbs_sbs.sbs_result -vbs_sbs.oracle_result)) as n_par10,vbs_sbs.oracle_result, vbs_sbs.sbs_result FROM (SELECT oracle_table.scenario_name, oracle_table.fold, oracle_table.metric, oracle_result, sbs_result FROM (SELECT scenario_name, fold, approach, metric, result as oracle_result FROM `vbs_sbs` WHERE approach='oracle') as oracle_table JOIN (SELECT scenario_name, fold, approach, metric, result as sbs_result FROM `vbs_sbs` WHERE approach='sbs') as sbs_table ON oracle_table.scenario_name = sbs_table.scenario_name AND oracle_table.fold=sbs_table.fold AND oracle_table.metric = sbs_table.metric) as vbs_sbs JOIN adaboostsamme_per_algo_40_it ON vbs_sbs.scenario_name = adaboostsamme_per_algo_40_it.scenario_name AND vbs_sbs.fold = adaboostsamme_per_algo_40_it.fold AND vbs_sbs.metric = adaboostsamme_per_algo_40_it.metric WHERE vbs_sbs.metric='par10') as final WHERE metric='par10' AND NOT scenario_name='CSP-Minizinc-Obj-2016' AND approach LIKE '%SAMME_per_algorithm_regressor%' AND scenario_name='CSP-Minizinc-Time-2016'")
    csp_mzn = get_dataframe_for_sql_query(
        "SELECT scenario_name, approach, fold, n_par10 as result FROM (SELECT vbs_sbs.scenario_name, vbs_sbs.fold, adaboostsamme_per_algo_40_it.approach, vbs_sbs.metric, adaboostsamme_per_algo_40_it.result, ((adaboostsamme_per_algo_40_it.result - vbs_sbs.oracle_result)/(vbs_sbs.sbs_result -vbs_sbs.oracle_result)) as n_par10,vbs_sbs.oracle_result, vbs_sbs.sbs_result FROM (SELECT oracle_table.scenario_name, oracle_table.fold, oracle_table.metric, oracle_result, sbs_result FROM (SELECT scenario_name, fold, approach, metric, result as oracle_result FROM `vbs_sbs` WHERE approach='oracle') as oracle_table JOIN (SELECT scenario_name, fold, approach, metric, result as sbs_result FROM `vbs_sbs` WHERE approach='sbs') as sbs_table ON oracle_table.scenario_name = sbs_table.scenario_name AND oracle_table.fold=sbs_table.fold AND oracle_table.metric = sbs_table.metric) as vbs_sbs JOIN adaboostsamme_per_algo_40_it ON vbs_sbs.scenario_name = adaboostsamme_per_algo_40_it.scenario_name AND vbs_sbs.fold = adaboostsamme_per_algo_40_it.fold AND vbs_sbs.metric = adaboostsamme_per_algo_40_it.metric WHERE vbs_sbs.metric='par10') as final WHERE metric='par10' AND NOT scenario_name='CSP-Minizinc-Obj-2016' AND approach LIKE '%SAMME_per_algorithm_regressor%' AND scenario_name='CSP-MZN-2013'")
    gluhack = get_dataframe_for_sql_query(
        "SELECT scenario_name, approach, fold, n_par10 as result FROM (SELECT vbs_sbs.scenario_name, vbs_sbs.fold, adaboostsamme_per_algo_40_it.approach, vbs_sbs.metric, adaboostsamme_per_algo_40_it.result, ((adaboostsamme_per_algo_40_it.result - vbs_sbs.oracle_result)/(vbs_sbs.sbs_result -vbs_sbs.oracle_result)) as n_par10,vbs_sbs.oracle_result, vbs_sbs.sbs_result FROM (SELECT oracle_table.scenario_name, oracle_table.fold, oracle_table.metric, oracle_result, sbs_result FROM (SELECT scenario_name, fold, approach, metric, result as oracle_result FROM `vbs_sbs` WHERE approach='oracle') as oracle_table JOIN (SELECT scenario_name, fold, approach, metric, result as sbs_result FROM `vbs_sbs` WHERE approach='sbs') as sbs_table ON oracle_table.scenario_name = sbs_table.scenario_name AND oracle_table.fold=sbs_table.fold AND oracle_table.metric = sbs_table.metric) as vbs_sbs JOIN adaboostsamme_per_algo_40_it ON vbs_sbs.scenario_name = adaboostsamme_per_algo_40_it.scenario_name AND vbs_sbs.fold = adaboostsamme_per_algo_40_it.fold AND vbs_sbs.metric = adaboostsamme_per_algo_40_it.metric WHERE vbs_sbs.metric='par10') as final WHERE metric='par10' AND NOT scenario_name='CSP-Minizinc-Obj-2016' AND approach LIKE '%SAMME_per_algorithm_regressor%' AND scenario_name='GLUHACK-18'")
    maxsat12 = get_dataframe_for_sql_query(
        "SELECT scenario_name, approach, fold, n_par10 as result FROM (SELECT vbs_sbs.scenario_name, vbs_sbs.fold, adaboostsamme_per_algo_40_it.approach, vbs_sbs.metric, adaboostsamme_per_algo_40_it.result, ((adaboostsamme_per_algo_40_it.result - vbs_sbs.oracle_result)/(vbs_sbs.sbs_result -vbs_sbs.oracle_result)) as n_par10,vbs_sbs.oracle_result, vbs_sbs.sbs_result FROM (SELECT oracle_table.scenario_name, oracle_table.fold, oracle_table.metric, oracle_result, sbs_result FROM (SELECT scenario_name, fold, approach, metric, result as oracle_result FROM `vbs_sbs` WHERE approach='oracle') as oracle_table JOIN (SELECT scenario_name, fold, approach, metric, result as sbs_result FROM `vbs_sbs` WHERE approach='sbs') as sbs_table ON oracle_table.scenario_name = sbs_table.scenario_name AND oracle_table.fold=sbs_table.fold AND oracle_table.metric = sbs_table.metric) as vbs_sbs JOIN adaboostsamme_per_algo_40_it ON vbs_sbs.scenario_name = adaboostsamme_per_algo_40_it.scenario_name AND vbs_sbs.fold = adaboostsamme_per_algo_40_it.fold AND vbs_sbs.metric = adaboostsamme_per_algo_40_it.metric WHERE vbs_sbs.metric='par10') as final WHERE metric='par10' AND NOT scenario_name='CSP-Minizinc-Obj-2016' AND approach LIKE '%SAMME_per_algorithm_regressor%' AND scenario_name='MAXSAT12-PMS'")
    maxsat15 = get_dataframe_for_sql_query(
        "SELECT scenario_name, approach, fold, n_par10 as result FROM (SELECT vbs_sbs.scenario_name, vbs_sbs.fold, adaboostsamme_per_algo_40_it.approach, vbs_sbs.metric, adaboostsamme_per_algo_40_it.result, ((adaboostsamme_per_algo_40_it.result - vbs_sbs.oracle_result)/(vbs_sbs.sbs_result -vbs_sbs.oracle_result)) as n_par10,vbs_sbs.oracle_result, vbs_sbs.sbs_result FROM (SELECT oracle_table.scenario_name, oracle_table.fold, oracle_table.metric, oracle_result, sbs_result FROM (SELECT scenario_name, fold, approach, metric, result as oracle_result FROM `vbs_sbs` WHERE approach='oracle') as oracle_table JOIN (SELECT scenario_name, fold, approach, metric, result as sbs_result FROM `vbs_sbs` WHERE approach='sbs') as sbs_table ON oracle_table.scenario_name = sbs_table.scenario_name AND oracle_table.fold=sbs_table.fold AND oracle_table.metric = sbs_table.metric) as vbs_sbs JOIN adaboostsamme_per_algo_40_it ON vbs_sbs.scenario_name = adaboostsamme_per_algo_40_it.scenario_name AND vbs_sbs.fold = adaboostsamme_per_algo_40_it.fold AND vbs_sbs.metric = adaboostsamme_per_algo_40_it.metric WHERE vbs_sbs.metric='par10') as final WHERE metric='par10' AND NOT scenario_name='CSP-Minizinc-Obj-2016' AND approach LIKE '%SAMME_per_algorithm_regressor%' AND scenario_name='MAXSAT15-PMS-INDU'")
    qbf = get_dataframe_for_sql_query(
        "SELECT scenario_name, approach, fold, n_par10 as result FROM (SELECT vbs_sbs.scenario_name, vbs_sbs.fold, adaboostsamme_per_algo_40_it.approach, vbs_sbs.metric, adaboostsamme_per_algo_40_it.result, ((adaboostsamme_per_algo_40_it.result - vbs_sbs.oracle_result)/(vbs_sbs.sbs_result -vbs_sbs.oracle_result)) as n_par10,vbs_sbs.oracle_result, vbs_sbs.sbs_result FROM (SELECT oracle_table.scenario_name, oracle_table.fold, oracle_table.metric, oracle_result, sbs_result FROM (SELECT scenario_name, fold, approach, metric, result as oracle_result FROM `vbs_sbs` WHERE approach='oracle') as oracle_table JOIN (SELECT scenario_name, fold, approach, metric, result as sbs_result FROM `vbs_sbs` WHERE approach='sbs') as sbs_table ON oracle_table.scenario_name = sbs_table.scenario_name AND oracle_table.fold=sbs_table.fold AND oracle_table.metric = sbs_table.metric) as vbs_sbs JOIN adaboostsamme_per_algo_40_it ON vbs_sbs.scenario_name = adaboostsamme_per_algo_40_it.scenario_name AND vbs_sbs.fold = adaboostsamme_per_algo_40_it.fold AND vbs_sbs.metric = adaboostsamme_per_algo_40_it.metric WHERE vbs_sbs.metric='par10') as final WHERE metric='par10' AND NOT scenario_name='CSP-Minizinc-Obj-2016' AND approach LIKE '%SAMME_per_algorithm_regressor%' AND scenario_name='QBF-2011'")
    sat03 = get_dataframe_for_sql_query(
        "SELECT scenario_name, approach, fold, n_par10 as result FROM (SELECT vbs_sbs.scenario_name, vbs_sbs.fold, adaboostsamme_per_algo_40_it.approach, vbs_sbs.metric, adaboostsamme_per_algo_40_it.result, ((adaboostsamme_per_algo_40_it.result - vbs_sbs.oracle_result)/(vbs_sbs.sbs_result -vbs_sbs.oracle_result)) as n_par10,vbs_sbs.oracle_result, vbs_sbs.sbs_result FROM (SELECT oracle_table.scenario_name, oracle_table.fold, oracle_table.metric, oracle_result, sbs_result FROM (SELECT scenario_name, fold, approach, metric, result as oracle_result FROM `vbs_sbs` WHERE approach='oracle') as oracle_table JOIN (SELECT scenario_name, fold, approach, metric, result as sbs_result FROM `vbs_sbs` WHERE approach='sbs') as sbs_table ON oracle_table.scenario_name = sbs_table.scenario_name AND oracle_table.fold=sbs_table.fold AND oracle_table.metric = sbs_table.metric) as vbs_sbs JOIN adaboostsamme_per_algo_40_it ON vbs_sbs.scenario_name = adaboostsamme_per_algo_40_it.scenario_name AND vbs_sbs.fold = adaboostsamme_per_algo_40_it.fold AND vbs_sbs.metric = adaboostsamme_per_algo_40_it.metric WHERE vbs_sbs.metric='par10') as final WHERE metric='par10' AND NOT scenario_name='CSP-Minizinc-Obj-2016' AND approach LIKE '%SAMME_per_algorithm_regressor%' AND scenario_name='SAT03-16_INDU'")
    sat12 = get_dataframe_for_sql_query(
        "SELECT scenario_name, approach, fold, n_par10 as result FROM (SELECT vbs_sbs.scenario_name, vbs_sbs.fold, adaboostsamme_per_algo_40_it.approach, vbs_sbs.metric, adaboostsamme_per_algo_40_it.result, ((adaboostsamme_per_algo_40_it.result - vbs_sbs.oracle_result)/(vbs_sbs.sbs_result -vbs_sbs.oracle_result)) as n_par10,vbs_sbs.oracle_result, vbs_sbs.sbs_result FROM (SELECT oracle_table.scenario_name, oracle_table.fold, oracle_table.metric, oracle_result, sbs_result FROM (SELECT scenario_name, fold, approach, metric, result as oracle_result FROM `vbs_sbs` WHERE approach='oracle') as oracle_table JOIN (SELECT scenario_name, fold, approach, metric, result as sbs_result FROM `vbs_sbs` WHERE approach='sbs') as sbs_table ON oracle_table.scenario_name = sbs_table.scenario_name AND oracle_table.fold=sbs_table.fold AND oracle_table.metric = sbs_table.metric) as vbs_sbs JOIN adaboostsamme_per_algo_40_it ON vbs_sbs.scenario_name = adaboostsamme_per_algo_40_it.scenario_name AND vbs_sbs.fold = adaboostsamme_per_algo_40_it.fold AND vbs_sbs.metric = adaboostsamme_per_algo_40_it.metric WHERE vbs_sbs.metric='par10') as final WHERE metric='par10' AND NOT scenario_name='CSP-Minizinc-Obj-2016' AND approach LIKE '%SAMME_per_algorithm_regressor%' AND scenario_name='SAT12-INDU'")
    ...
    for i, df in enumerate(dfs):
        ...
        for iter in range(1, max_it + 1):
            ...
            for fold in range(1, 11):
                approach = 'SAMME_per_algorithm_regressor_%d' % (iter)
