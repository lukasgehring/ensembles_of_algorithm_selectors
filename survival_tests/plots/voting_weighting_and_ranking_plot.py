...
def generate_sbs_vbs_change_table():
    ...
    ax.bar(0.9, voting_rank1234567.result, width, color=color2, label='Ranked Voting (avg ranking)')

    ax.bar(1.1, voting_weighting_1234567.result, width, color=color3, label='Weighted Voting')

    ax.bar(1.3, voting_weighting_ranking_1234567.result, width, color=color4, label='Weighted-Ranked Voting (avg ranking)')
    ...
    ax.bar(2.3, voting_weighting_ranking_24567.result, width, color=color4)
    ...
    ax.text(1.3, float(voting_weighting_ranking_1234567.result), round(float(voting_weighting_ranking_1234567.result), 3), ha='center', va='bottom', rotation=0)
    ...
    ax.text(2.3, float(voting_weighting_ranking_24567.result), round(float(voting_weighting_ranking_24567.result), 3), ha='center', va='bottom', rotation=0)
