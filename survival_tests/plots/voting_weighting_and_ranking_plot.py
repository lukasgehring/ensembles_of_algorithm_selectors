...
def generate_sbs_vbs_change_table():
    ...
    ax.bar(0.79, voting1234567.result, width, color=color1, label='Majority Voting', zorder=6)
    ax.bar(0.93, voting_ranking_1234567.result, width, color=color2, label='Ranked Voting (avg ranking)', zorder=6)
    ax.bar(1.07, voting_weighting_1234567.result, width, color=color3, label='Weighted Voting', zorder=6)
    ax.bar(1.21, voting_ranknig_weighting_1234567.result, width, color=color4,
           label='Weighted-Ranked Voting (avg ranking)', zorder=6)

    ax.bar(1.59, voting24567.result, width, color=color1, zorder=6)
    ax.bar(1.73, voting_ranking_24567.result, width, color=color2, zorder=6)
    ax.bar(1.87, voting_weighting_24567.result, width, color=color3, zorder=6)
    ax.bar(2.01, voting_ranknig_weighting_24567.result, width, color=color4, zorder=6)
    ...
    ax.text(1.07, float(voting_weighting_1234567.result), round(float(voting_weighting_1234567.result), 3), ha='center', va='bottom', rotation=0)
    ax.text(1.21, float(voting_ranknig_weighting_1234567.result), round(float(voting_ranknig_weighting_1234567.result), 3), ha='center', va='bottom', rotation=0)
    ...
    ax.text(1.87, float(voting_weighting_24567.result), round(float(voting_weighting_24567.result), 3), ha='center', va='bottom', rotation=0)
    ax.text(2.01, float(voting_ranknig_weighting_24567.result), round(float(voting_ranknig_weighting_24567.result), 3), ha='center', va='bottom', rotation=0)
    ...
    fig.savefig("plotted/voting_weighting.pdf", bbox_inches='tight')
