...
def generate_sbs_vbs_change_table():
    ...
    per_algorithm_regressor_linear_se = get_dataframe_for_sql_query(
    ...
    multiclass_algorithm_selector_square_se = get_dataframe_for_sql_query(
        "SELECT scenario_name, AVG(n_par10) as result FROM (SELECT vbs_sbs.scenario_name, vbs_sbs.fold, adaboostr2_per_algorithm_regressor.approach, vbs_sbs.metric, adaboostr2_per_algorithm_regressor.result, ((adaboostr2_per_algorithm_regressor.result - vbs_sbs.oracle_result)/(vbs_sbs.sbs_result -vbs_sbs.oracle_result)) as n_par10,vbs_sbs.oracle_result, vbs_sbs.sbs_result FROM (SELECT oracle_table.scenario_name, oracle_table.fold, oracle_table.metric, oracle_result, sbs_result FROM (SELECT scenario_name, fold, approach, metric, result as oracle_result FROM `vbs_sbs` WHERE approach='oracle') as oracle_table JOIN (SELECT scenario_name, fold, approach, metric, result as sbs_result FROM `vbs_sbs` WHERE approach='sbs') as sbs_table ON oracle_table.scenario_name = sbs_table.scenario_name AND oracle_table.fold=sbs_table.fold AND oracle_table.metric = sbs_table.metric) as vbs_sbs JOIN adaboostr2_per_algorithm_regressor ON vbs_sbs.scenario_name = adaboostr2_per_algorithm_regressor.scenario_name AND vbs_sbs.fold = adaboostr2_per_algorithm_regressor.fold AND vbs_sbs.metric = adaboostr2_per_algorithm_regressor.metric WHERE vbs_sbs.metric='par10') as final WHERE metric='par10' AND NOT scenario_name='CSP-Minizinc-Obj-2016' AND approach LIKE 'adaboostR2_per_algorithm_regressor_square_%_se' GROUP BY scenario_name")

    per_algorithm_regressor_linear = get_dataframe_for_sql_query(
        "SELECT scenario_name, AVG(n_par10) as result FROM (SELECT vbs_sbs.scenario_name, vbs_sbs.fold, adaboostr2_per_algorithm_regressor.approach, vbs_sbs.metric, adaboostr2_per_algorithm_regressor.result, ((adaboostr2_per_algorithm_regressor.result - vbs_sbs.oracle_result)/(vbs_sbs.sbs_result -vbs_sbs.oracle_result)) as n_par10,vbs_sbs.oracle_result, vbs_sbs.sbs_result FROM (SELECT oracle_table.scenario_name, oracle_table.fold, oracle_table.metric, oracle_result, sbs_result FROM (SELECT scenario_name, fold, approach, metric, result as oracle_result FROM `vbs_sbs` WHERE approach='oracle') as oracle_table JOIN (SELECT scenario_name, fold, approach, metric, result as sbs_result FROM `vbs_sbs` WHERE approach='sbs') as sbs_table ON oracle_table.scenario_name = sbs_table.scenario_name AND oracle_table.fold=sbs_table.fold AND oracle_table.metric = sbs_table.metric) as vbs_sbs JOIN adaboostr2_per_algorithm_regressor ON vbs_sbs.scenario_name = adaboostr2_per_algorithm_regressor.scenario_name AND vbs_sbs.fold = adaboostr2_per_algorithm_regressor.fold AND vbs_sbs.metric = adaboostr2_per_algorithm_regressor.metric WHERE vbs_sbs.metric='par10') as final WHERE metric='par10' AND NOT scenario_name='CSP-Minizinc-Obj-2016' AND (approach='adaboostR2_per_algorithm_regressor_linear_1' OR approach='adaboostR2_per_algorithm_regressor_linear_2' OR approach='adaboostR2_per_algorithm_regressor_linear_3' OR approach='adaboostR2_per_algorithm_regressor_linear_4' OR approach='adaboostR2_per_algorithm_regressor_linear_5' OR approach='adaboostR2_per_algorithm_regressor_linear_6' OR approach='adaboostR2_per_algorithm_regressor_linear_7' OR approach='adaboostR2_per_algorithm_regressor_linear_8' OR approach='adaboostR2_per_algorithm_regressor_linear_9' OR approach='adaboostR2_per_algorithm_regressor_linear_10' OR approach='adaboostR2_per_algorithm_regressor_linear_11' OR approach='adaboostR2_per_algorithm_regressor_linear_12' OR approach='adaboostR2_per_algorithm_regressor_linear_13' OR approach='adaboostR2_per_algorithm_regressor_linear_14' OR approach='adaboostR2_per_algorithm_regressor_linear_15' OR approach='adaboostR2_per_algorithm_regressor_linear_16' OR approach='adaboostR2_per_algorithm_regressor_linear_17' OR approach='adaboostR2_per_algorithm_regressor_linear_18' OR approach='adaboostR2_per_algorithm_regressor_linear_19' OR approach='adaboostR2_per_algorithm_regressor_linear_20') GROUP BY scenario_name")

    print(per_algorithm_regressor_linear_se)
    fig = plt.figure(1, figsize=(5, 4))

    ax = fig.add_subplot(111)

    a = list()
    a.append(np.average(per_algorithm_regressor_linear_se.result))
    a.append(np.average(multiclass_algorithm_selector_square_se.result))

    c = list()
    c.append(np.average(per_algorithm_regressor_linear.result))
